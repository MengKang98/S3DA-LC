 # Alleviating Imbalanced Pseudo-label Proportion in Target Domain: Self-Supervised Multi-Source Domain Adaptation with Label-specific Confidence(Submitted to NeurIPS 2023)
